...
def get_swagger(file,domain_name):
    ...
    if domain_name is None:
        domain1 = domain = urlparse(web).netloc
    else:
        domain1 = domain_name   
                ...
                if 'response' in request:
                    ...
                    if status_code not in swagger_spec['paths'][path][method.lower()]['responses']:
                        ...
                        if 'mimeType' in request['response']['content']:
                            ...
                            swagger_spec['paths'][path][method.lower()]['consumes'] = [request['response']['content']['mimeType']]    
...
def covnvertswag():
    ...
    with open('harswag/static/swagger.json', 'w') as file:
